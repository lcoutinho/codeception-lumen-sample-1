...
APPNAME='Use2Pay API Documentation'
CMDFILE=apigen.cmd.$$
DESTDIR=./documents
SRCDIRS="app"
VENDORDIRS="vendor/guzzlehttp vendor/symfony vendor/incube8 vendor/laravel/lumen-framework/src vendor/illuminate vendor/league/flysystem/src vendor/monolog/monolog/src"
